...
export const RenderCarouselAction: React.FC<
  GridRenderCellParams<any, models.CampaignEntityModel, any>
> = (props) => {
  const appContext = useContext(AppContext);
  const campaign = props.row;
  ...
  return (
    <Select
      ...
      onChange={async (event) => {
        ...
        try {
          campaign.featured = selectedValue;
    ...
    >
      {models.featuredCampaignOptions.map((option: string) => (
        <MenuItem
